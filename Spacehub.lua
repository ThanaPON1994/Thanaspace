...
function ClickEffect(r)
    spawn(
        function()
            ...
            wait(0.25)
            b.TweenService:Create(s, TweenInfo.new(0.001), {ImageTransparency = 1}):Play()
            repeat
                wait()
...
function a:Window(w)
    ...
    local function I()
        ...
        b.TweenService:Create(
            E,
            TweenInfo.new(0.001, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut),
    ...
    function K:Slider(Y, Z, _, a0, N, S, T)
        ...
        local function ab(p)
            ...
            a8:TweenSize(ac, Enum.EasingDirection.InOut, Enum.EasingStyle.Linear, 0.001, true)
