-- SPACE v1.4 — AlphaGo WikiRace (Fast 777 + Fast Scan)
-- 🐷 Pink Pig Edition
...
local function addLine(text, color)
    ...
    l.Parent = scroll
    -- 🆕 ลบ scroll.CanvasPosition (เร็วขึ้น)
end
...
-- 🆕 navigateToTitle: ลดเหลือ 4 ระดับ
...
local function doGo()
    ...
    -- 🆕 ข้าม scanBlue ถ้ามี lastHopCandidates
