...
-- 🆕 小女孩 = CURRENT + GOAL + CANDIDATES (ไม่มี prompt)
...
-- ============ 小女孩 = COPY 3 ส่วน (CURRENT/GOAL/CANDIDATES) ============
hopBtn.MouseButton1Click:Connect(function()
    ...
    -- 🆕 copy 3 ส่วน: CURRENT / GOAL / CANDIDATES
    local lines = {
        "CURRENT: " .. cur,
        "GOAL: " .. tgt,
        "",
    ...
    statusLbl.Text = "📋 Copied (" .. #cands .. " cands)"
    hopArticle = cur
end)
...
addLine("小女孩 = CURRENT + GOAL + cands", PINK_DEEP)
addLine("🐽 = copy target only", TEAL)
addLine("777 = paste + GO ⚡ (0 delay)", GREEN_OK)
statusLbl.Text = "🐽 Ready ⚡"
updateLabels()

print("[ATLAS v9.3 🐽 GOAL] Loaded ✓")
