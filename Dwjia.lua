...
-- 🆕 Fix: refreshCapColor "endend" typo
-- 🆕 Fix: superNormalize HTML entities
...
addLine("🐷 v8.8 No-Reject + Fuzzy (FIXED)", GREEN_OK)
addLine("小女孩 → เช็ค Goal → Fire 🔥", PINK_DEEP)
addLine("Cap = " .. currentCap .. " (แก้ได้ 1-1000)", PINK_DARK)
statusLbl.Text = "🐽 Ready"
updateLabels()

print("[ATLAS v8.8 🐷 No-Reject + Fuzzy FIXED] Loaded ✓")
