-- ATLAS v9.3 — 🥙 EDITION ⚡
-- 🐷 Pink Pig Edition (350 x 326) — 傳說中的龍女來了
-- 🆕 ปุ่ม小女孩 = SPEEDRUN prompt + CURRENT + TARGET + CANDIDATES
-- 🆕 ปุ่ม 🥙 = COPY TARGET ONLY
-- 🆕 ลบ GO — ใช้ 777 (paste + GO อัตโนมัติ) แทน
-- 🆕 777 + CLEAR = เต็มแถว
...
frame.Size = UDim2.new(0, 350, 0, 326)
...
copyTargetBtn.Size = UDim2.new(1, -12, 0, 22)
copyTargetBtn.Position = UDim2.new(0, 6, 0, 94)
...
statusLbl.Position = UDim2.new(0, 6, 0, 120)
...
pasteLbl.Position = UDim2.new(0, 6, 0, 138)
...
pasteBox.Position = UDim2.new(0, 6, 0, 152)
...
-- ===== Row: 777 / CLEAR (เต็มแถว 2 ปุ่ม) =====
local pasteBtn = Instance.new("TextButton")
pasteBtn.Size = UDim2.new(0.5, -9, 0, 26)
pasteBtn.Position = UDim2.new(0, 6, 0, 198)
pasteBtn.BackgroundColor3 = PINK_DARK
pasteBtn.Text = "777 (paste + GO)"
...
clearJsonBtn.Position = UDim2.new(0.5, 3, 0, 198)
...
scroll.Size = UDim2.new(1, -12, 1, -236)
scroll.Position = UDim2.new(0, 6, 0, 230)
...
copyTargetBtn.MouseButton1Click:Connect(function()
    ...
    addLine("[🥙] target: " .. targetTitle .. (ok and " ✓" or " FAIL"),
...
addLine("777 = paste + GO ⚡", GREEN_OK)
statusLbl.Text = "🐽 Ready ⚡"
updateLabels()

print("[ATLAS v9.3 🥙] Loaded ✓")
