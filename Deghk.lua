-- ATLAS v9.5.2 — FULL FIX + 111 PROMPT
-- 🐷 Pink Pig Edition — Cap hidden 250 + No Goal + Fast 777
...
addLine("🐷 v9.5.2 FULL FIX + 111 PROMPT", GREEN_OK)
addLine("小女孩 → Prompt สั้น | 777 → เร็วสุด", PINK_DEEP)
addLine("111 → Prompt มี Fallback + กฎ", ORANGE_WARN)
statusLbl.Text = "🐽 Ready"
updateLabels()

print("[ATLAS v9.5.2 🐷 FULL FIX + 111 PROMPT] Loaded ✓")
